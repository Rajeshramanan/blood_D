...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['request_id']) && isset($_POST['action'])) {
    ...
    if (in_array($action, ['Accepted', 'Rejected'])) {
        try {
            // Update the response status for this specific donor
            ...
            // If accepted, check total accepted responses for this request
            if ($action === 'Accepted') {
                ...
                // If we have enough donors, mark the overall request as Completed
